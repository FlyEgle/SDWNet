'''
Reference from https://github.com/BrehmiumPwr/deblurring_ntire2020/blob/master/model_stage1.py
'''
import torch
import torch.nn as nn
from model.NTIRE2020_Deblur_top.uniA.layerlib_stage1 import Conv2D_ReflectPad, AtrousBlockPad2
...
class AtrousNet(nn.Module):
    def __init__(self, in_channels, out_channels, num_blocks=10, max_global_stride=8, pad_to_fit_global_stride=True,
        ...
        self.upsampling_layers.append(nn.ConvTranspose2d(in_channels=self.d_mult * 6,  # Error: should be 4
                                                         ...
                                                         output_padding=1,
                                                         bias=True))
        self.upsampling_layers.append(nn.ReLU(True))
