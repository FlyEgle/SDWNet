...
class Padding(object):
    """padding refilect
    """
    def __init__(self, padding_size, mode="symmetric"):
...
class ResizeRandomCrop(object):
    """resize the size with the src image size + crop size
    """
...
class PaddingRandomCrop(object):
    """padding the size with the src image size + crop size
    """
    def __init__(self, crop_size):
...
if __name__ == "__main__":
    lr = "/data/jiangmingchao/data/dataset/DeRain/train/input/13589.jpg"
    hr = "/data/jiangmingchao/data/dataset/DeRain/train/target/13589.jpg"
    lr_image = Image.open(lr)
    hr_image = Image.open(hr)

    crop = ResizeRandomCrop((416, 416))
    lr_crop, hr_crop = crop(lr_image, hr_image)
    lr_crop.save("/data/jiangmingchao/data/lr_1.jpg")
    hr_crop.save("/data/jiangmingchao/data/hr_1.jpg")
    print(lr_crop.size)
